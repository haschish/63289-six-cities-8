    ...
    <article className={classNames(className, 'place-card')} onMouseOver={onMouseOver} onMouseLeave={onMouseLeave}>
      ...
      <div className="place-card__info">
        <div className="place-card__price-wrapper">
          ...
          <button className={classNames('place-card__bookmark-button button', {'place-card__bookmark-button--active': data.isFavorite})} type="button" onClick={onClickBookmarkButton}>
